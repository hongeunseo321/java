...
/*
 * 1. 순서를 가지고 있다 (인덱스 번호가 자동 부여) ==> 배열기반 0번부터
 * 2. 저장된 데이터 중복 허용
 * 3. CRUD (메모리 상) 주로 사용
 ...
 *     데이터 존재 여부 : isEmpty()
 *                    ---------
 * 6. 주 사용처 => 오라클에서 데이터를 읽어서 => 브라우저로 전송 
 *               쿠키를 읽어서 브라우저 전송
 */
import java.util.*;
...
//		}
		...
		// 자동으로 조정
		System.out.println("저장된 인원:"+list.size()); // 3
		...
		for(int i=0;i<list.size();i++)
		{
			...
			// 자동으로 조정
			System.out.println("저장된 인원:"+list.size()); // 0
