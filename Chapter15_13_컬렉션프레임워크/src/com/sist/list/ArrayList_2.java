...
/*
 * List
 *  => CRUD 기능 (add, remove, set, get, size)
 *  => containsAll() : 두 개의 list에서 중복된 데이터를 모아서 관리
 *                     오라클 => JOIN
 *  => retainAll() : 중복 데이터 찾기 (부분 집합)
 *  => addAll() : 데이터 전체 값 추가
...
public class ArrayList_2 {
	...
	public static void main(String[] args) {
		...
		// start, end => end-1 => 1 2 3 => 인덱스 번호 추출
		list2.add(10);
		list2.add(11);
		list2.add(12);
		 ...
		 * => 페이징
		 * 
		 * addAll(0 => list가 가지고 있는 모든 데이터를 복사
		 * 
		 * retainAll() => 두 개의 ArrayList에 있는 교집합
		 * 
		 * Collectons.sort() => 정렬
		 */
	}
