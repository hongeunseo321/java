...
import java.awt.*; // 레이아웃(Layout) => 배치
import java.awt.event.*;
import java.io.BufferedReader; // 이벤트 => 인터페이스 => Listener
...
implements ActionListener,Runnable{
	...
	public ChatClientForm()
	{
		...
		// 배치
		setLayout(null);
		js.setBounds(8,12,449,500);
		add(js);
		tf.setBounds(8,520,300,30);
		b1.setBounds(313,520,69,30);
		b2.setBounds(387,520,69,30);
