 ...
 * 	java.io.* : 입출력과 관련된 라이브러리
 * 	java.net.* : 네트워크와 관련된 라이브러리
 * 	java.swing.* : 윈도우와 관련된 경량 라이브러리 => 1.2
 * 	java.awt.* : 윈도우와 관련된 라이브러리 => 1.0
 *  ---------------------------------------------
 ...
 * 생성자 ===> 메소드 / 변수 사용 시 메모리 저장 => 다른 클래스에서 사용 가능
...
public class 접근지정어 {
	...
	public static void main(String[] args) {
		 ...
		 * 2. JVM
		 * 		this=hong
		 * => this는 인스턴스 메소드나 생성자 사용 가능
		 *    static에는 존재하지 않는다
		 */
		System.out.println("===== 정보 =====");
		System.out.println("사번:"+hong.getSabun()); // 출력 불가
