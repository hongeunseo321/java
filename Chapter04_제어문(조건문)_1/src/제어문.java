 ...
 *				(여러 개의 문장을 제어할 때 {})
 *				=> 가독성 / 수정 편리 => {}
 *			*** 제어문에 틀별한 경우가 아니면 ;를 사용하지 않는다
 *			if (조건문); => 밑에 있는 모든 명령문을 수행하지 않는다
 *			{
 *				명령문;
 *			}
 *			if (조건문)
...
public class 제어문 {
	...
	public static void main(String[] args) {
		...
		// 같은 블록에서는 변수명 중복이 되면 안 된다
		System.out.println("a="+a);
		System.out.println("b="+b);
		System.out.println("c="+c);
		
		int max=a; // 임의의 초기화 => 1
		// 조건 true 수행 / false일 때는 수행하지 않는다
		if(max<b)
		{
			max=b;
