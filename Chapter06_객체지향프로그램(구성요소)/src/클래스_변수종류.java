 ...
 * 		class A
 * 		{
 * 			int a; => 메모리에 저장이 안 된 상태
 * 			static int b; => 메모리에 저장된 상태
 * 		}
 * 
 * 		A aa=new A();	a=>저장
 *           --- ---> 변수의 초기값을 메모리에 저장
 *            |동적 메모리 => new마다 새로운 메모리를 만들어 준다
 *             => 클래스에 선언된 변수를 모아서 한 개의 메모리를 만들어 준다
 *             => 메모리 주소를 객체변수에 전송
 *      ---aa---
 * 	     0x100
 * 		--------    0x100--------
 ...
 * 					     --------
 * 		---- b ----
 *           0 ==> aa, bb가 동시에 사용이 가능 => aa.b, bb.bb
 *             ==> A.b
 *      -----------
 *      
 *      Scanner scna=new Scanner(System.in)
 *      scan.nextInt() => 메모리에 저장된 데이터
 *      Scanner scna=new Scanner(System.in)
 *      scan1.nextInt()
 *      
 *      Math.random() => static
...
public class 클래스_변수종류 {
	...
	public static void main(String[] args) {
		...
		// Student@1f32e575 ==> hakbun/name/sex
		/*
		 * Student@1f32e575
		 * ----------------
		 * 	--- hakbun ---
		 *        0       => Student@1f32e575.hakbun
		 *  --------------   -----------------------
		 *                         hong.hakbun
		 *  ---- name ---- => hong.name
		 *       null
...
//		System.out.println(hong);
		...
		hong.name="홍길동1"; // 인스턴스 변수라서 바뀌지 않는다
		...
		System.out.println("학교명:"+shim.schoolName);
		System.out.println("학교명:"+hong.schoolName);
