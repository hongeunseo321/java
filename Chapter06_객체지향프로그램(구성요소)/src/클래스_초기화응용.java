...
class MovieSystem // 액션 클래스
{
	// 공유 => 데이터베이스 : 공유된 데이터 ==> static
	static Movie[] movies=new Movie[1938];
	
	// 초기화 블록은 자동 수행, 상속 예외, 클래스 안에서 구현을 이용한 초기화가 가능
	static
	{
		try // 파일 입출력은 반드시 예외 처리해서 사용
		{
...
public class 클래스_초기화응용 {
	...
	public static void main(String[] args) {
		...
		while(true)
		{
			...
			{
				int i=0;
				for(Movie m:MovieSystem.movies) // static
				{
