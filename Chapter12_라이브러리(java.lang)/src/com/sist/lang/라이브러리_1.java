...
public class 라이브러리_1 /*extends Object 생략이 되어있다*/ {
	...
	public static void main(String[] args) {
		...
		try
		{
			// 초기값이 같은 메모리 복제 => 새로운 메모리 생성
			Sawon shim=(Sawon)hong.clone(); // 깊은 복사
			// prototype
			shim.print();
			shim.name="심청이";
			shim.sex="여자";
			...
			// Call by Reference
			Sawon kim=shim; // 얕은 복사 => 주소 참조 (같은 메모리 공간을 공유)
			// 별칭 => 같은 주소 제어
			kim.name="김두한";
			kim.sex="남자";
			shim.name="심청이";
