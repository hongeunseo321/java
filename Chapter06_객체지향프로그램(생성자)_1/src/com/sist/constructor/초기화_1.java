 ...
 * 		--------------------
 * 		 변수
 * 		  = 데이터를 따로 저장 => new를 이용해서 메모리 공간을 만든다
 * 		                      데이터를 저장
 * 		                      인스턴스 변수
 * 		                      *** new를 이용하면 메모리가 따로 생성
 * 		                      *** new를 사용 시에는 반드시 생성자를 동반한다
 * 		                      형식 => new 생성자() 
 * 		                             ----------
 * 		                             new => 클래스 크기 확인
 * 		                                    메모리를 만든다
...
public class 초기화_1 {
	...
	public static void main(String[] argsgdsfdssdg) {
