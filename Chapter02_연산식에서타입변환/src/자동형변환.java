 ...
 * 		   		   javac            java
 * 				   컴파일			  인터프리터
 * 			 (컴퓨터 언어로 변경) (한 줄씩 읽어서 출력)
 * 					 |               |
 * 			      컴파일영역		   실행 시
 * 				  -------문법       입력값
 * 				=> 프로그래머 실수	   사용자
 * 		=> 프로그램 개발 => 다시 사용해야 되는 데이터
 * 						 ------------------- 메모리에 저장 (변수)
 ...
 * 			=> 기본
 * 		문자
 * 			문자 한 개만 저장 => 0~65535 (각국의 언어 사용이 가능)
 * 			char => 표현식 ''
 * 		논리
 ...
 *  
 *  				(char)65 => 'A'
 *  				(int)10.5 => 10 => DownCasting
 *  
 *  				**boolean은 변환이 안 된다 (87page)
 *  
 ...
 *  
 *  		입출력 => 69page
 *  		System.out.printle() : 가장 많이 사용
 *  		---------------------> 웹 => 입력값 확인, 오류 메세지 출력
 *  		사용을 하면 => 줄바꿈
 *  		System.out.print() : 문법 사항 => 줄바꿈이 안 된다
 *  							 가로로 출력 => 한 명에 대한 데이터 출력
...
//		int math=scan.nextInt();
		...
		//int eng=scan.nextInt();
		//int math=scan.nextInt();
		//ystem.out.printf("%3d%3d%3d\n",kor,eng,math);
//		System.out.println("문자열 입력:");
//		String msg=scan.nextLine(); //nextLine : 공백포함
