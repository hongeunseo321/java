 ...
 *      	}
 *      	------------------
 *      	객체지향 프로그램의 특성 : 캡슐화, 상속, 추상화, 수정, 추가
 *      		=> 권장사항 => OOP에 접근하지 않아도 된다
 *      
 *		public : 모든 클래스에서 접근 가능 (패키지와 관련 X)
 *
 ...
 *			=> 저장되는 시점 : new => 따로 저장
 *				객체명.메소드()
 *		정적 메소드 (1%) ==> 공통 사용 => 한글 변환
 *			=> 저장되는 시점 : 컴파일 시에 저장
 *				클래스명.메소드명()
 *			=> 이미지 축소 / 확대
 *		추상 메소드 ==> 여러 개 클래스가 공통인 기능
 *			=> 추상 클래스 / 인터페이스	
 *		종단 메소드 (0.0000000001%) ==> final 
 *			=> 사용 빈도가 거의 없다
 *		
 *		-------------------------------------
 *		class Human
